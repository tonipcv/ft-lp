      ...
      <section id="planos" className="py-16 px-4 bg-black">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
            <div className="border-[0.5px] border-neutral-800 p-8 rounded-lg text-center order-2 md:order-1">
            ...
            <div className="relative border-[0.5px] border-green-100/20 bg-green-100/[0.02] p-8 rounded-lg text-center order-1 md:order-2">
              ...
              <a 
                ...
                target="_blank"
                rel="noopener noreferrer"
                onClick={() => handleSubscribeClick('annual_promo')}
                className="inline-block border border-neutral-800 text-neutral-300 px-6 py-2 text-xs hover:bg-white/5 transition-colors"
              >
                {language === 'pt' ? 'Assinar' : 'Subscribe'}
              </a>
